...
// 曲线3
class BottomClipper3 extends CustomClipper<Path>{
  @override
    Path getClip(Size size) {
      var path = Path();
      path.lineTo(0, 0);
      path.lineTo(0, size.height-100);
      var firstControlPoint =Offset(size.width/4*1,size.height-150);
      var firstEndPoint = Offset(size.width/4*2,size.height);
